...
const CLIENTS = ['MTN Cameroun','Orange Cameroun','Client OEM','Nexttel Cameroun','Gouvernement Cameroun','CAMTEL','Entreprise Privée'];
...
const SEED_PROJETS = [
  ...
  { id:'3', reference:'PROJ-2024-003', titre:'Survey et préparation site Garoua Nord', client:'Client OEM', technicien:'Ali Moussa', chefProjet:'Marie Kamga', site:'GAR-001', montantTotal:8500000, devise:'FCFA', status:'brouillon', planPaiement:'2phases', phases:[{id:1,label:'Acompte démarrage',pct:50,montant:4250000,status:'attente',datePaiement:null,reference:null},{id:2,label:'Solde livraison',pct:50,montant:4250000,status:'attente',datePaiement:null,reference:null}], dateCreation:'2024-02-15', dateDebut:null, dateFin:null, progression:0, description:'Survey complet du site GAR-001.', historique:[] },
