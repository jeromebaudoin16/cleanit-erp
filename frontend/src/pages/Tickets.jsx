...
const SEED = [
  ...
  { id:3, code:'TK-00003', title:'Swap antenne 4G→5G Yaoundé Centre', type:'swap', priority:'haute', status:'in_progress', site:'YDE-001', technicien:'Jean Mbarga', description:'Remplacement RRU 4G par équipements 5G NR Client.', createdAt: new Date(Date.now()-172800000).toISOString() },
