...
const NAV = [
  ...
  { section:'ENTREPRISE', color:'#34c97e', items:[
    ...
    { path:'/bons-commande', label:'Bons de Commande', icon:'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  ...
  { path:'/mobile', label:'App Mobile', icon:'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z' },
