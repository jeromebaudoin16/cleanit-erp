...
const meteo_entity_1 = require("./meteo.entity");
...
exports.MeteoModule = MeteoModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([meteo_entity_1.Meteo])],
        providers: [meteo_service_1.MeteoService],
        controllers: [meteo_controller_1.MeteoController],
        exports: [meteo_service_1.MeteoService],
    })
], MeteoModule);
