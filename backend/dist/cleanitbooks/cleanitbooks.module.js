...
exports.CleanITBooksModule = CleanITBooksModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([customer_entity_1.Customer, vendor_entity_1.Vendor, job_entity_1.Job, invoice_entity_1.Invoice, bill_entity_1.Bill, timeentry_entity_1.TimeEntry])],
        providers: [cleanitbooks_service_1.CleanITBooksService],
        controllers: [cleanitbooks_controller_1.CleanITBooksController],
        exports: [cleanitbooks_service_1.CleanITBooksService],
    })
], CleanITBooksModule);
